...
import com.mason.ATD.graphATD.*;

/**
 * @author Mason
 * @Description 用于已存在图的操作的接口
 * @date 2022/5/5 16:45
 */
public interface GraphAlgorithmsInterface<T> {
     ...
     * @param origin  An object that labels the origin vertex of the traversal.
     * @return  A queue of labels the vertices in the traversal, with lable of the
     *          origin vertex at the queue's front.
     */
